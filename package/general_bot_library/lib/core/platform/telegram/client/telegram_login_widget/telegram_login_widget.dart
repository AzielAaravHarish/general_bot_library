...
// import 'package:general_bot_library/telegram/scheme/telegram_client_library_telegram_login_widget_user.dart';
// import 'package:general_bot_library/scheme/scheme/general_bot_library_platform_telegram_telegram_login_widget_user_general_bot_library.dart';
...
class TelegramLogin {
  ...
  /// run executable telegram bot api
  Future<GeneralBotLibraryPlatformTelegramTelegramLoginWidgetUserGeneralBotLibrary> getMe({
    http.Client? httpClient,
  }) async {
    httpClient ??= http_client;
    Map<String, String> headers = {
    ...
    try {
      ...
      userData["@type"] = "error";
      return GeneralBotLibraryPlatformTelegramTelegramLoginWidgetUserGeneralBotLibrary(userData);
    }
