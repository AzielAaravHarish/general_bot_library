...
extension CreateInvoiceLinkDataOn on GeneralBotPlatformTelegramCoreBaseLibrary {
  /// method CreateInvoiceLink
  FutureOr<Map> createInvoiceLink({
    ...
    Map request_parameters = <dynamic, dynamic>{
      ...
      "invoice": <dynamic, dynamic>{
        ...
        "payload": parameters["payload"].toString().general_universe_utils_encryptToBase64(),
        "invoice": <dynamic, dynamic>{
          "@type": "invoice",
