...
extension ReportMessagesDataOn on GeneralBotPlatformTelegramCoreBaseLibrary {
  /// method ReportMessages
  FutureOr<Map> reportMessages({
    ...
    Map request_parameters = {
      ...
      "message_ids": (parameters["message_ids"] as List).map((e) => GeneralUniverseUtils.messageApiToTdlib(e)).toList(),
