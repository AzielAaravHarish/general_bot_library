...
extension GetChatDataOn on GeneralBotPlatformTelegramCoreBaseLibrary {
  /// TelegramClientUncompleDocumentation
          ...
          if (value is Map || value is List) {
            ...
            try {
              if (RegExp(r"(message_id)", caseSensitive: false).hasMatch(key)) {
                newScheme["detail"][key] = GeneralUniverseUtils.messageTdlibToApi(value);
              } else {
                newScheme["detail"][key] = value;
              }
            } catch (e) {
                ...
                if (value is Map) {
                  ...
                  try {
                    if (RegExp(
                      ...
                      newScheme["detail"][key] = GeneralUniverseUtils.messageTdlibToApi(
                        value,
                      );
                    } else {
                      newScheme["detail"][key] = value;
