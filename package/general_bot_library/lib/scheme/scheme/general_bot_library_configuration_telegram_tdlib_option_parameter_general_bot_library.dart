...
/// Generated 
class GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary extends JsonScheme {

  /// Generated
  GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary(super.rawData);
  
  /// return default special type @type
  /// "generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary"
  ...
  /// create [GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary]
  /// Empty  
  static GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary empty() {
    return GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary({});
  }
  ...
  /// Generated
  static GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary create({
              bool schemeUtilsIsSetDefaultData = false,

    String special_type = "generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary",
    num? api_id,
    String? api_hash,
    ...
    // GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary = GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary({
final Map generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary_data_create_json = {
      ...
      "use_test_dc": use_test_dc,
          ...
          generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary_data_create_json.removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary_data_create_json.containsKey(key) == false) {
          generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary_data_create_json[key] = value;
        }
      });
    }
return GeneralBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary(generalBotLibraryConfigurationTelegramTdlibOptionParameterGeneralBotLibrary_data_create_json);
