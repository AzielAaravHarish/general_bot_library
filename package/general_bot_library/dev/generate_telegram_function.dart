...
void main(List<String> args) async {
  ...
  Directory directory = Directory(
    // package/general_bot_library/lib/core/platform/telegram/client
    join(
...
extension ${method_origin.toUpperCaseFirstData()}DataOn on GeneralBotPlatformTelegramCoreBaseLibrary {
