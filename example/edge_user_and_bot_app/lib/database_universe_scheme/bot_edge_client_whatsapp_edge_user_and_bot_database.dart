...
part "bot_edge_client_whatsapp_edge_user_and_bot_database.g.dart";

@collection
class BotEdgeClientWhatsappEdgeUserAndBotDatabase {
  ...
  static Map get defaultData {
    return {"@type": "botEdgeClientWhatsappEdgeUserAndBotDatabase", "from_app_id": "", "owner_account_user_id": 0, "id": 0};
  }
  ...
  static BotEdgeClientWhatsappEdgeUserAndBotDatabase create({
    ...
    BotEdgeClientWhatsappEdgeUserAndBotDatabase botEdgeClientWhatsappEdgeUserAndBotDatabase_data_create = BotEdgeClientWhatsappEdgeUserAndBotDatabase();

    if (utils_is_print_data) {
      // print(botEdgeClientWhatsappEdgeUserAndBotDatabase_data_create.toStringPretty());
    }

    return botEdgeClientWhatsappEdgeUserAndBotDatabase_data_create;
  }
}
