...
part "bot_edge_client_telegram_edge_user_and_bot_local_database.g.dart";

@collection
class BotEdgeClientTelegramEdgeUserAndBotLocalDatabase {
  ...
  static Map get defaultData {
    return {"@type": "botEdgeClientTelegramEdgeUserAndBotLocalDatabase", "client_token": "", "client_user_id": 0, "client_is_bot": false, "client_tdlib_id": 0, "from_app_id": "", "owner_account_user_id": 0, "id": 0};
  }
  ...
  static BotEdgeClientTelegramEdgeUserAndBotLocalDatabase create({
    ...
    BotEdgeClientTelegramEdgeUserAndBotLocalDatabase botEdgeClientTelegramEdgeUserAndBotLocalDatabase_data_create = BotEdgeClientTelegramEdgeUserAndBotLocalDatabase();

    if (utils_is_print_data) {
      // print(botEdgeClientTelegramEdgeUserAndBotLocalDatabase_data_create.toStringPretty());
    }

    return botEdgeClientTelegramEdgeUserAndBotLocalDatabase_data_create;
  }
}
